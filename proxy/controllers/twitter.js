...
//
function makeTwitterRequest(path, params, callback, errorHandler) {
	request({
...
function healthCheck(req, res) {
	makeTwitterRequest(
		...
		err => {
			debug('Twitter is not responding - have you added your Consumer Key & Consumer Secret as environment variables?');
